...
const projectsData: Project[] = [
    {
        ...
        siteLink: 'https://confeitaria-dias.vercel.app/vitrine/index.html',
    ...
    },
    {
        image: nearbyImg,
        title: 'Nearby',
        description: 'App para uso de cupons em lojas parceiras perto de você. Uso de Geolocalização e câmera do dispositivo usando Typescript, React e React Native.(SEM LINK PARA TESTE).',
